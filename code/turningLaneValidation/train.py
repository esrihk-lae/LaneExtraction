...
class Train(TrainingFramework):
	def __init__(self, mode = "seg"):
		self.mode = mode
		self.image_size = 640
		self.batch_size = 4		# dky - original: 8, unofficial sets this to 1
		...
		print(f">>> class Train(), pass Popen, modelFolder={self.modelfolder}, validationFolder={self.validationfolder}")
		self.counter = 0
		self.disloss = 0
